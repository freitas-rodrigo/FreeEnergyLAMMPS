"""
  This script plots the free energy vs temperature, as computed from the Frenkel-Ladd thermodynamic integration.
...
T, F, Q = loadtxt('../data/processed/free_energy.dat', unpack=True)
